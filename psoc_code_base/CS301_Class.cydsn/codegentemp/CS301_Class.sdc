...
# Date: Mon, 24 Jul 2023 09:41:48 GMT
#set_units -time ns
create_clock -name {ADC_IntClock(routed)} -period 83.333333333333314 -waveform {0 41.6666666666667} [list [get_pins {ClockBlock/dclk_0}]]
...
create_generated_clock -name {ADC_IntClock} -source [get_pins {ClockBlock/clk_sync}] -edges {1 5 11} -nominal_period 83.333333333333314 [list [get_pins {ClockBlock/dclk_glb_0}]]
...
# Project: C:\Users\AKLbc\Desktop\301\psoc_code_base\CS301_Class.cydsn\CS301_Class.cyprj
# Date: Mon, 24 Jul 2023 09:41:37 GMT
