...
# Date: Mon, 24 Jul 2023 06:04:44 GMT
#set_units -time ns
create_clock -name {ADC_IntClock(routed)} -period 549.99999999999989 -waveform {0 275} [list [get_pins {ClockBlock/dclk_1}]]
...
create_generated_clock -name {ADC_IntClock} -source [get_pins {ClockBlock/clk_sync}] -edges {1 33 67} -nominal_period 549.99999999999989 [list [get_pins {ClockBlock/dclk_glb_1}]]
