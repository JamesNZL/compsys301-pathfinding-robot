...
#define BS_IOPINS0_8_VAL ((const uint8 CYFAR *)0x480000FCu)
...
#define BS_IOPINS0_2_VAL ((const uint8 CYFAR *)0x48000110u)
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)CYREG_PRT2_AMUX, 0x2002u);
