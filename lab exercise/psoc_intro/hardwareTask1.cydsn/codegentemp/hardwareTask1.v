...
module ADC_SAR_v3_10_2 (
	...
	cy_clock_v1_0
		#(.id("3a2424d8-fea0-4a0c-9c36-fc8f4f50f265/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("4308a7bd-d315-4bdc-ad6f-1e9fcd4efdb8"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("6601aa8b-b162-4cfb-b4b9-f0afbce4deac"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
