...
#define SENSOR_DEFAULT_BIAS_VOLTAGE_VOLTS	 1.1F
...
#define SENSOR_SAMPLING_PERIODS				 7 // Amount of times to sample all the sensors after a rising edge
#define SENSOR_SAMPLING_PERIOD_COMPARE		 10 // 100 us - Delay between each sensor sample on a rising edge
#define SENSOR_RISING_EDGE_MAX_DELAY_COMPARE 1100 // 20 ms - The maximum time allowed after a rising edge before all sensors are assumed to be off
